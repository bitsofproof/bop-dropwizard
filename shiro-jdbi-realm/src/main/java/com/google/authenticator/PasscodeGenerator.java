...
/**
 * An implementation of the HOTP generator specified by RFC 4226. Generates short passcodes that may be used in challenge-response protocols or as timeout
...
public class PasscodeGenerator
{
	...
	public String generateResponseCode (long state, byte[] challenge) throws GeneralSecurityException
	{
		...
		else
		{
			...
			byte value[] = ByteBuffer.allocate (8 + challenge.length).putLong (state) // Write out OTP state
