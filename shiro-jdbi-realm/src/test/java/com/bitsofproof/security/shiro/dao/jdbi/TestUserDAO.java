...
public class TestUserDAO {
    ...
    {
        SecurityUser u = harness.getUserSecurityDAO().findUserWithoutRoles("TEST");
        assertNotNull(u);
    ...
    public void createAUser() // throws SQLException;
    {
        ...
        SecurityRole r = new DefaultRoleImpl("user", Collections.singleton("bar"));
        u = new DefaultUserImpl(null, "FOO", "PASSWORD", null, Collections.singleton(r));
    ...
    public void createUser_noRoles() // throws SQLException;
    {
        ...
        u = new DefaultUserImpl(null, "FOO", "PASSWORD", null, null);
        Long newId = harness.getUserDAO().createUser(u);
        assertNotNull(newId);
        assertEquals(newId, u.getId());
    ...
    public void createUser_noSuchRole() // throws SQLException;
    {
        ...
        SecurityRole r = new DefaultRoleImpl("fakey", Collections.singleton("blah"));
        u = new DefaultUserImpl(null, "FOO", "PASSWORD", null, Collections.singleton(r));
    ...
    public void createUser_IdSpecified() // throws SQLException;
    {
        ...
        SecurityRole r = new DefaultRoleImpl("user", Collections.singleton("bar"));
        u = new DefaultUserImpl(1001l, "FOO", "PASSWORD", null, Collections.singleton(r));
    ...
    {
        DefaultUserImpl u1 = new DefaultUserImpl(null, "A", "B", null, null);
        DefaultUserImpl u2 = new DefaultUserImpl(null, "A", "B", null, null);
    ...
    public void testTransaction_withRemnants()
    {
        ...
        SecurityRole r = new DefaultRoleImpl("user", Collections.singleton("bar"));
        u = new DefaultUserImpl(null, "txFOO", "PASSWORD", null, Collections.singleton(r));
